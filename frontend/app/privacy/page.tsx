...
export const metadata: Metadata = {
  ...
  description: "How Quantrelic Analytics handles personal data.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-20">
      <Reveal>
        ...
        <div className="mx-auto max-w-3xl space-y-8 rounded-3xl border border-white/5 bg-ink-900/60 p-8 text-sm leading-relaxed text-paper-dim/85">
          ...
          <div>
            <h2 className="text-base font-semibold text-paper">What we collect</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-base font-semibold text-paper">Why and on what basis</h2>
            <p className="mt-2">
              Waitlist entries are used solely to contact you about early access to QRA.
              Feedback is used to improve the site and products. Applications are used
              for recruitment. Every purpose requires a separate, explicit consent,
              recorded with the policy version you saw.
            </p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-paper">Your choices</h2>
          ...
          <div>
            <h2 className="text-base font-semibold text-paper">Sharing</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-base font-semibold text-paper">Retention</h2>
            <p className="mt-2">
